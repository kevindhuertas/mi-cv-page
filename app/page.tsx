...
const Home = () => {
  ...
  const cardData = [
    {
      ...
      // imageUrls: [, '/images/exp_hover.jpg', '/images/exp_detail.png']
      imageUrl: '/me/yo.jpg' ,
      onClick: () => openModal(
  ...
  return (
    <div className=" bg-white  dark:bg-gray-800 text-gray-900 dark:text-gray-100  min-h-screen flex flex-col items-center"> {/* Cambiado color de selección */}
        <Header/>
        <HeroSection />

         {/* Ajusta max-w- y px- según tu diseño general */}
  ...
  {' '}
        ...
        <div className=" dark:bg-gray-100 dark:text-black bg-slate-900 w-full -mt-10 pt-20 relative z-0 "> {/* Empuja el footer hacia arriba y le da padding top */}
            <FooterSection />
        </div>
