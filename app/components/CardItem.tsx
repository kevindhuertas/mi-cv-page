...
// Nuevas props:
// disableHoverAnimation: boolean, si es true, no habrá animación de hover (movimiento/escala)
// borderRadiusClass: string, clase de Tailwind para el redondeo (ej: 'rounded-lg', 'rounded-2xl')
const CardItem = ({
  title,
  text,
  imageUrl,
  ...
  const handleMouseMove = (e) => {
    // Si la animación está deshabilitada, no necesitamos calcular la posición
  ...
  const isGif = typeof currentImageUrl === 'string' && currentImageUrl.toLowerCase().endsWith('.gif');
