...
export type GalleryItem = {
  ...
  tecnologies?: string;
  year: string;
  categorie: "work" | "play"; // puedes agregar más si hay otras categorías
  imageUrl: string;
  appUrl?: string; // algunos usan AppUrl, otros appUrl
  AppUrl?: string; // se incluyen ambos para prevenir errores por inconsistencias
  gitUrl?: string;
